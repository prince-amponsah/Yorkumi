...
if( !class_exists( 'Dt_Woo_Listing_Option_Thumb_Element_Group' ) ) {

    class Dt_Woo_Listing_Option_Thumb_Element_Group extends Dt_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'dt_theme_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 55, 1 );
        }
...
if( !function_exists('dt_woo_listing_option_thumb_element_group') ) {
	function dt_woo_listing_option_thumb_element_group() {
		return Dt_Woo_Listing_Option_Thumb_Element_Group::instance();
	}
}

dt_woo_listing_option_thumb_element_group();