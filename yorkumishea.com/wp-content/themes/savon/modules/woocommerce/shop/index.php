...
if( !class_exists( 'Dt_Woo_Listing_Shop' ) ) {

    class Dt_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'savon_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('dt_woo_listing_shop') ) {
	function dt_woo_listing_shop() {
		return Dt_Woo_Listing_Shop::instance();
	}
}
