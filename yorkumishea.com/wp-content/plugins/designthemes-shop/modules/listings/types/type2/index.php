...
if( !class_exists( 'Dt_Woo_Listing_Type_Type2' ) ) {

    class Dt_Woo_Listing_Type_Type2 {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                $this->type_slug = 'type2';
                $this->type_name = esc_html__('Type 2', 'dtshop');
        ...
        */
            function woo_default_product_templates( $templates ) {
                ...
                $default_template = array (
                    ...
                    'title'           => sprintf( esc_html__( 'Product Templates - %1$s', 'dtshop' ), $this->type_name ),
                    'button_title'    => esc_html__('Add New', 'dtshop'),
                    'accordion_title' => esc_html__('Add New Template', 'dtshop'),
            ...
            function set_type_options() {
                ...
                $type_options['product-content-content']        = array (
                    ...
                    'disabled'     => array(
                        ...
                        'element_group'  => esc_html__('Element Group', 'dtshop'),
                        'swatches'       => esc_html__('Swatches', 'dtshop'),
                        'product_notes'  => esc_html__('Product Notes', 'dtshop')
                    )
                );
...
if( !function_exists('dt_woo_listing_type_type2') ) {
	function dt_woo_listing_type_type2() {
		return Dt_Woo_Listing_Type_Type2::instance();
	}
}

dt_woo_listing_type_type2();