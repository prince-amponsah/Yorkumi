<?php
/**
 * This class loads all the classes for Limit OTP Addon.
 *
...
if ( ! class_exists( 'RcSplClassLoader' ) ) {
	/**
	 * This class loads all the classes.
	 */
	final class RcSplClassLoader {
		/**
		 * File extention.
		 *
		 * @var string
		...
		public function load_class( $class_name ) {
			...
			if ( null === $this->namespace || $this->is_same_namespace( $class_name ) ) {
				...
				$file_name1      = str_replace( 'roc', MO_ROC_NAME, $file_name );
