...
if( ! function_exists( 'cs_validate_email' ) ) {
  function cs_validate_email( $value, $field ) {
    ...
    if ( ! sanitize_email( $value ) ) {
      return esc_html__( 'Please write a valid email address!', 'designthemes-framework' );
    }
...
if( ! function_exists( 'cs_validate_numeric' ) ) {
  function cs_validate_numeric( $value, $field ) {
    ...
    if ( ! is_numeric( $value ) ) {
      return esc_html__( 'Please write a numeric data!', 'designthemes-framework' );
    }
...
if( ! function_exists( 'cs_validate_required' ) ) {
  function cs_validate_required( $value ) {
    if ( empty( $value ) ) {
      return esc_html__( 'Fatal Error! This field is required!', 'designthemes-framework' );
    }
  }
