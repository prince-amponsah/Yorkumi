...
class CSFramework_Option_Image extends CSFramework_Options {
  ...
  public function output(){
    ...
    $add     = ( ! empty( $this->field['add_title'] ) ) ? $this->field['add_title'] : esc_html__( 'Add Image', 'designthemes-framework' );
    ...
    echo '<div class="cs-image-preview'. $hidden .'"><div class="cs-preview"><i class="fa fa-times cs-remove"></i><img src="'. $preview .'" alt="'.esc_attr__('preview', 'designthemes-framework').'" /></div></div>';
