...
class DT_WP_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'designthemes-framework-fontawesome-control', DT_FW_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), DT_FW_VERSION, true );
		wp_enqueue_style( 'designthemes-framework-fontawesome-control',  DT_FW_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, DT_FW_VERSION );

		wp_enqueue_style( 'designthemes-framework-fontawesome',  DT_FW_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),DT_FW_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "designthemes-framework") .' '.esc_html( $this->label );	 	
