...
if( !class_exists( 'DesignThemesH5Settings' ) ) {
    class DesignThemesH5Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'dt_theme_h5_selector', array( 'h5' ) );
            $this->settings = dt_customizer_settings('h5_typo');
        ...
        function register( $wp_customize ) {
            $wp_customize->add_section(
                new DT_WP_Customize_Section(
                    ...
                    'site-h5-section',
                    array(
                        'title'    => esc_html__('H5 Typograpy', 'designthemes-theme'),
                ...
                $wp_customize->add_setting(
                    DT_CUSTOMISER_VAL . '[h5_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new DT_WP_Customize_Control_Typography(
                        $wp_customize, DT_CUSTOMISER_VAL . '[h5_typo]', array(
                            'type'    => 'dt-typography',
                            'section' => 'site-h5-section',
                            'label'   => esc_html__( 'H5 Tag', 'designthemes-theme'),
                        )
                    )
                );
                 ...
                 */
                $wp_customize->add_setting(
                    DT_CUSTOMISER_VAL . '[h5_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, DT_CUSTOMISER_VAL . '[h5_color]', array(
        ...
        function base_style( $style ) {
            $css   = '';
            $color = dt_customizer_settings('h5_color');
...
DesignThemesH5Settings::instance();