...
if( !class_exists( 'DesignThemesH3Settings' ) ) {
    class DesignThemesH3Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'dt_theme_h3_selector', array( 'h3' ) );
            $this->settings = dt_customizer_settings('h3_typo');
        ...
        function register( $wp_customize ) {
            $wp_customize->add_section(
                new DT_WP_Customize_Section(
                    ...
                    'site-h3-section',
                    array(
                        'title'    => esc_html__('H3 Typograpy', 'designthemes-theme'),
                ...
                $wp_customize->add_setting(
                    DT_CUSTOMISER_VAL . '[h3_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new DT_WP_Customize_Control_Typography(
                        $wp_customize, DT_CUSTOMISER_VAL . '[h3_typo]', array(
                            'type'    => 'dt-typography',
                            'section' => 'site-h3-section',
                            'label'   => esc_html__( 'H3 Tag', 'designthemes-theme'),
                        )
                    )
                );
                 ...
                 */
                $wp_customize->add_setting(
                    DT_CUSTOMISER_VAL . '[h3_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, DT_CUSTOMISER_VAL . '[h3_color]', array(
        ...
        function base_style( $style ) {
            $css   = '';
            $color = dt_customizer_settings('h3_color');
...
DesignThemesH3Settings::instance();