...
if( !class_exists( 'DesignThemesH2Settings' ) ) {
    class DesignThemesH2Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'dt_theme_h2_selector', array( 'h2' ) );
            $this->settings = dt_customizer_settings('h2_typo');
        ...
        function register( $wp_customize ) {
            $wp_customize->add_section(
                new DT_WP_Customize_Section(
                    ...
                    'site-h2-section',
                    array(
                        'title'    => esc_html__('H2 Typograpy', 'designthemes-theme'),
                ...
                $wp_customize->add_setting(
                    DT_CUSTOMISER_VAL . '[h2_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new DT_WP_Customize_Control_Typography(
                        $wp_customize, DT_CUSTOMISER_VAL . '[h2_typo]', array(
                            'type'    => 'dt-typography',
                            'section' => 'site-h2-section',
                            'label'   => esc_html__( 'H2 Tag', 'designthemes-theme'),
                        )
                    )
                );
                 ...
                 */
                $wp_customize->add_setting(
                    DT_CUSTOMISER_VAL . '[h2_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, DT_CUSTOMISER_VAL . '[h2_color]', array(
        ...
        function base_style( $style ) {
            $css   = '';
            $color = dt_customizer_settings('h2_color');
...
DesignThemesH2Settings::instance();