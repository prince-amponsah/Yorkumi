...
if( !class_exists( 'DesignThemesH4Settings' ) ) {
    class DesignThemesH4Settings {
        ...
        function __construct() {
            $this->selector = apply_filters( 'dt_theme_h4_selector', array( 'h4' ) );
            $this->settings = dt_customizer_settings('h4_typo');
        ...
        function register( $wp_customize ) {
            $wp_customize->add_section(
                new DT_WP_Customize_Section(
                    ...
                    'site-h4-section',
                    array(
                        'title'    => esc_html__('H4 Typograpy', 'designthemes-theme'),
                ...
                $wp_customize->add_setting(
                    DT_CUSTOMISER_VAL . '[h4_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new DT_WP_Customize_Control_Typography(
                        $wp_customize, DT_CUSTOMISER_VAL . '[h4_typo]', array(
                            'type'    => 'dt-typography',
                            'section' => 'site-h4-section',
                            'label'   => esc_html__( 'H4 Tag', 'designthemes-theme'),
                        )
                    )
                );
                 ...
                 */
                $wp_customize->add_setting(
                    DT_CUSTOMISER_VAL . '[h4_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, DT_CUSTOMISER_VAL . '[h4_color]', array(
        ...
        function base_style( $style ) {
            $css   = '';
            $color = dt_customizer_settings('h4_color');
...
DesignThemesH4Settings::instance();