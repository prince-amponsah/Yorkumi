...
if( !class_exists( 'DesignThemesBlogArchiveElementor' ) ) {
    class DesignThemesBlogArchiveElementor {
        ...
        function load_modules() {
            foreach( glob( DT_THEME_DIR_PATH. 'modules/blog/elementor/widgets/*/index.php'  ) as $module ) {
                include_once $module;
            }
        }
...
DesignThemesBlogArchiveElementor::instance();