...
if( !class_exists( 'BlogPaginationInfiniteScroll' ) ) {
    class BlogPaginationInfiniteScroll {
        ...
        function enqueue_js_assets() {
        	wp_enqueue_script( 'post-infinite', DT_THEME_DIR_URL . 'modules/blog/assets/js/post-infinite.js', array(), DT_THEME_VERSION, true );
			wp_localize_script('post-infinite', 'dttheme_urls', array(
