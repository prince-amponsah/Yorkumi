    ...
    class Dt_Woo_Listing_Type_Type1 {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Type 1', 'designthemes-theme');
        ...
        */
            function woo_default_product_templates( $templates ) {
                ...
                $default_template = array (
                    ...
                    'title'           => sprintf( esc_html__( 'Product Templates - %1$s', 'designthemes-theme' ), $this->type_name ),
            ...
            function set_type_options() {
                ...
                $type_options['product-thumb-content']          = array (
                    'enabled'      => array (
                        ...
                        'category'       => esc_html__('Category', 'designthemes-theme'),
                        'price'          => esc_html__('Price', 'designthemes-theme')
                    ),
                    'disabled'     => array (
                        'button_element' => esc_html__('Button Element', 'designthemes-theme'),
                        'icons_group'    => esc_html__('Icons Group', 'designthemes-theme'),
                        'excerpt'        => esc_html__('Excerpt', 'designthemes-theme'),
                        'rating'         => esc_html__('Rating', 'designthemes-theme'),
                        'countdown'      => esc_html__('Count Down', 'designthemes-theme'),
                        'separator'      => esc_html__('Separator', 'designthemes-theme'),
                        'element_group'  => esc_html__('Element Group', 'designthemes-theme'),
                        'swatches'       => esc_html__('Swatches', 'designthemes-theme')
                    )
                );
                ...
                $type_options['product-content-content']        = array (
                    ...
                    'disabled'     => array(
                        ...
                        'element_group'  => esc_html__('Element Group', 'designthemes-theme'),
                        'swatches'       => esc_html__('Swatches', 'designthemes-theme'),
                        'product_notes'  => esc_html__('Product Notes', 'designthemes-theme')
                    )
                );
                $type_options['product-content-element-group']  = array (
                    'enabled'      => array(
                        'cart'           => esc_html__('Cart', 'designthemes-theme'),
                        'category'       => esc_html__('Category', 'designthemes-theme')
                    ),
                    'disabled'     => array(
                        'title'          => esc_html__('Title', 'designthemes-theme'),
                        'price'          => esc_html__('Price', 'designthemes-theme'),
                        'wishlist'       => esc_html__('Wishlist', 'designthemes-theme'),
                        'compare'        => esc_html__('Compare', 'designthemes-theme'),
                        'quickview'      => esc_html__('Quick View', 'designthemes-theme'),
                        'button_element' => esc_html__('Button Element', 'designthemes-theme'),
                        'icons_group'    => esc_html__('Icons Group', 'designthemes-theme'),
                        'excerpt'        => esc_html__('Excerpt', 'designthemes-theme'),
                        'rating'         => esc_html__('Rating', 'designthemes-theme'),
