...
class Dt_Theme_Elementor {
	...
	public function load_modules() {
		...
		add_action( 'elementor/widgets/register', array( $this, 'dtshop_register_widgets' ) );
	...
	public function dtshop_register_category( $elements_manager ) {
		...
		$elements_manager->add_category(
			'dtshop-widgets', array(
				'title' => esc_html__( 'DesignThemes - Shop', 'designthemes-theme' ),
				'icon'  => 'font'
			)
		);
	...
	public function dtshop_register_widgets( $widgets_manager ) {
		...
		do_action( 'dtshop_register_widgets', $widgets_manager );
	...
	public function dtshop_register_widget_styles() {
		...
		do_action( 'dtshop_register_widget_styles', $suffix );
	...
	public function dtshop_register_widget_scripts() {
		...
		do_action( 'dtshop_register_widget_scripts', $suffix );
	...
	public function dtshop_preview_styles() {
		...
		do_action( 'dtshop_preview_styles' );

	}

}

Dt_Theme_Elementor::instance();