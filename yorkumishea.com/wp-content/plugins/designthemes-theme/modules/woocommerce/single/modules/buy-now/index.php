...
if( !class_exists( 'Dt_Shop_Single_Module_Buy_Now' ) ) {

    class Dt_Shop_Single_Module_Buy_Now {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( savon_is_file_in_theme( __FILE__ ) ) {
                    return SAVON_MODULE_DIR . '/woocommerce/single/modules/buy-now/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( savon_is_file_in_theme( __FILE__ ) ) {
                    return SAVON_MODULE_URI . '/woocommerce/single/modules/buy-now/';
                } else {
...
if( !function_exists('dt_shop_single_module_buy_now') ) {
	function dt_shop_single_module_buy_now() {
        $reflection = new ReflectionClass('Dt_Shop_Single_Module_Buy_Now');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Dt_Shop_Single_Module_Custom_template' ) ) {
    Dt_Shop_Single_Module_Buy_Now::instance();
}