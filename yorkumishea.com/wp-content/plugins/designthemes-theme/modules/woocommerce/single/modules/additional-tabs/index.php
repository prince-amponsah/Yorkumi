...
if( !class_exists( 'Dt_Shop_Single_Module_Additional_Tabs' ) ) {

    class Dt_Shop_Single_Module_Additional_Tabs {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( savon_is_file_in_theme( __FILE__ ) ) {
                    return SAVON_MODULE_DIR . '/woocommerce/single/modules/additional-tabs/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( savon_is_file_in_theme( __FILE__ ) ) {
                    return SAVON_MODULE_URI . '/woocommerce/single/modules/additional-tabs/';
                } else {
...
if( !function_exists('dt_shop_single_module_additional_tabs') ) {
	function dt_shop_single_module_additional_tabs() {
        $reflection = new ReflectionClass('Dt_Shop_Single_Module_Additional_Tabs');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Dt_Shop_Single_Module_Additional_Tabs::instance();