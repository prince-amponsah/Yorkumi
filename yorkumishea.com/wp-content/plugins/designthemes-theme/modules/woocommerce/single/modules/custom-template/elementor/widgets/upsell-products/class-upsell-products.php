...
class DTShop_Widget_Upsell_Products extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Product Single - Upsell Products', 'designthemes-theme' );
	}

	public function get_style_depends() {
		return array( 'dtshop-product-single-upsell-products' );
	}
		...
		if($settings['product_id'] != '') {
			...
			$output .= '<div class="dt-sc-product-upsell-products '.$settings['class'].'">';
				...
				if($settings['product_style_template'] == 'admin') {
					$product_style_template = dt_customizer_settings( 'dt-single-product-upsell-style-template' );
				} else {
