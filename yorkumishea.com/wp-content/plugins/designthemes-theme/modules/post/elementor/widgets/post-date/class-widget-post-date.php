...
class Elementor_Post_Date extends DTElementorWidgetBase {
    ...
    public function get_title() {
        return __('Post - Date', 'designthemes-theme');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-date-wrapper '.$style.' '.$el_class.'">';
            $out .= savon_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/date', '', $template_args );
		$out .= '</div>';
