...
class Elementor_Post_Categories extends DTElementorWidgetBase {

    public function get_name() {
        return 'dt-post-categories';
    }

    public function get_title() {
        return __('Post - Categories', 'designthemes-theme');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-categories-wrapper '.$style.' '.$el_class.'">';
            $out .= savon_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/category', '', $template_args );
		$out .= '</div>';
