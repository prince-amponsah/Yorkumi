...
class Elementor_Post_Tags extends DTElementorWidgetBase {
    ...
    public function get_title() {
        return __('Post - Tags', 'designthemes-theme');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-tags-wrapper '.$style.' '.$el_class.'">';
            $out .= savon_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/tag', '', $template_args );
		$out .= '</div>';
