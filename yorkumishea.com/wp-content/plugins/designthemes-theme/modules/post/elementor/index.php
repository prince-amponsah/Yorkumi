...
if( !class_exists( 'DesignThemesBlogPostElementor' ) ) {
    class DesignThemesBlogPostElementor {
        ...
        function load_modules() {
            foreach( glob( DT_THEME_DIR_PATH. 'modules/post/elementor/widgets/*/index.php'  ) as $module ) {
                include_once $module;
            }
        }
...
DesignThemesBlogPostElementor::instance();