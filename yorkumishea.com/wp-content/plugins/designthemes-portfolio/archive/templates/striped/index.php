...
if( !class_exists( 'DesignThemesPortfolioArchiveStripedTemplate' ) ) {
    class DesignThemesPortfolioArchiveStripedTemplate extends DesignThemesPortfolioArchiveBase {
        ...
        */
            ...
            function tpl_container_classes( $classes ) {
                ...
                // Post Style
                    array_push( $classes, 'dtportfolio-container-striped' );
        ...
        */
            ...
            function item_post_style_class( $classes ) {
                ...
                array_push( $classes, 'dtportfolio-striped' );
