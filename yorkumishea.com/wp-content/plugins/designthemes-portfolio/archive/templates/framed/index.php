...
if( !class_exists( 'DesignThemesPortfolioArchiveFramedTemplate' ) ) {
    class DesignThemesPortfolioArchiveFramedTemplate extends DesignThemesPortfolioArchiveBase {
        ...
        */
            ...
            function tpl_container_classes( $classes ) {
                ...
                // Post Style
                    array_push( $classes, 'dtportfolio-container-framed' );
        ...
        */
            ...
            function item_filters_and_actions() {
                ...
                add_filter( 'dtportfolio_item_classes', array ( $this, 'item_grid_space_class' ), 15, 1 );
                add_filter( 'dtportfolio_item_classes', array ( $this, 'item_category_filter_class' ), 20, 1 );
                add_filter( 'dtportfolio_item_classes', array ( $this, 'item_common_class' ), 25, 1 );
                add_filter( 'dtportfolio_item_classes', array ( $this, 'item_misc_hover_state_class' ), 30, 1 );
                add_filter( 'dtportfolio_item_classes', array ( $this, 'item_misc_masonry_size_class' ), 35, 1 );
                add_filter( 'dtportfolio_item_classes', array ( $this, 'item_misc_animation_class' ), 40, 1 );
            ...
            function item_post_style_class( $classes ) {
                ...
                array_push( $classes, 'dtportfolio-framed' );
